...
The growing body of research on rescue workers' resilience emphasizes the intricate relationships among various individual protective and risk factors that shape their post-traumatic reactions [@alexander2009first; @scuri2019training]. These factors operate across multiple dimensions, each with a distinct impact on psychological well-being and resilience [@ludick2017toward]. While physical health, certain demographic attributes, and positive personality traits like hopefulness act as resilience-enhancing factors, risk factors such as youthfulness, being female, or having a history of trauma can undermine it. Additionally, the use of positive coping mechanisms and robust social support networks bolster resilience, whereas negative coping styles and emotional instability act as detriments. Specialized training further fortifies resilience in this population [@mao2022characteristics].

While the previously listed dimensions are crucial, a notably underexplored aspect that can substantially contribute to resilience is self-compassion. The concept of the "self" has gained traction in recent years as a pivotal factor in individual differences in stress-coping [@beck2016self]. Self-compassion, characterized by a compassionate relationship with oneself, not only positively impacts mental health but also offers protective benefits against psychopathologies such as PTSD [@macbeth2012exploring; @wilson2019effectiveness; @wong2017self]. 

Self-compassion is typically measured using the Self-Compassion Scale (SCS). The SCS measures six dimensions of self-compassion, three of which evaluate the active components of self-compassion [@neff2022differential]. These dimensions include Self-kindness (SK), Common humanity (CH), and Mindfulness (MI), which involve being kind and understanding towards oneself, recognizing that personal failures and pain are common experiences, and maintaining awareness of one's painful thoughts and feelings. The remaining three dimensions evaluate the "hindrances" to self-compassion, such as being self-critical and unsympathetic towards one's shortcomings (Self-judgment; SJ), isolating oneself from others (Isolation; IS), and over-identifying with one's painful thoughts and emotions (Overidentification; OI).

Emerging research robustly supports an inverse relationship between stress and self-compassion, alongside a direct link between self-compassion and diminished occupational burnout [for a review, see @neff2023self]. Within this framework, specialized studies have begun to investigate the salience of self-compassion among rescue workers. For example, @pietrantoni2008resilience reported that among their sample of emergency and rescue personnel, levels of compassion fatigue and burnout were minimal, while job satisfaction was markedly high. @lowery2022health focused on a diverse cohort of full-time first responders -- encompassing police officers, firefighters, and emergency medical staff -- and established self-compassion as the predominant predictor of well-being within this demographic, a conclusion further reinforced by @zhao2020self. Considering firefighters specifically, @lv2023influence found that self-compassion and negative coping styles serve as intervening variables in the relationship between stress and occupational burnout, with higher stress correlating to reduced self-compassion. Interestingly for the present purposes, @shahsavarinia2022prediction parsed the different facets of self-compassion in relation to PTSD among healthcare professionals serving in COVID-19 specialized units, revealing that over-identification, self-judgment, and isolation were risk factors for PTSD, unlike other dimensions of self-compassion.

Given this backdrop, it is plausible to posit that self-compassion could serve as a key factor in enhancing resilience across various professions, including that of rescue workers. However, existing empirical literature has yet to address the role of individual differences in shaping this dynamic. Specifically, it remains an open question whether, within the rescue worker population, those who exhibit adaptive resilience patterns are more predisposed to utilize self-compassion as a coping strategy than their counterparts with maladaptive resilience tendencies. To fill this gap, the present study aims to elucidate the individual differences that characterize the relationships between varying levels of protective and risk factors among rescue workers and their propensity for employing self-compassion as a coping mechanism. Our objectives are twofold: (1) to identify distinct individual differences "profiles" based on unique combinations of protective and risk factors, and to examine their respective associations with varying levels of self-compassion, and (2) to determine which facets of self-compassion are predominantly linked to maladaptive resilience profiles in rescue workers.

To achieve these aims, we utilized Latent Profile Analysis (LPA) to categorize rescue workers based on distinct combinations of personality traits, protective factors, risk factors, and outcomes. We then examined whether those in the 'maladaptive' profile demonstrated elevated levels of the negative dimensions of self-compassion, in contrast to those within the 'adaptive' profile.  -->

<!-- To accomplish these objectives, we employed Latent Profile Analysis (LPA) as a methodological approach to discern distinct clusters of rescue workers, categorized by their specific protective and risk factors and resulting outcomes. We then correlated these LPA-identified groups with both the overall levels and the specific dimensions of self-compassion, shedding light on this underexplored yet crucial aspect of resilience. -->

<!-- Physical health has been singled out as a key protective factor, enhancing resilience among rescue workers. However, specific demographic characteristics, such as being young, female, single, or part of a minority group, as well as having prior traumatic experiences, are identified as risk factors that undermine resilience. Personality traits such as hopefulness, extroversion, and optimism function as protective elements by enhancing effective handling of traumatic situations. In contrast, emotional instability has been linked to increased susceptibility to PTSD and psychological stress.

Positive coping strategies like problem-focused coping and seeking social support are positively correlated with resilience, while negative strategies like self-blame and wishful thinking can deteriorate it. Perceived social support—ranging from family and friends to colleagues and the community—serves as an invaluable resource in bolstering resilience and preventing psychological ailments like anxiety, burnout, and PTSD. Specialized training further fortifies  resilience. -->
